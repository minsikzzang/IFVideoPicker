Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/ifactorylab/IFVideoPicker.git', :tag => "1.0.1", :submodules => true }
  ...
  s.source_files = 'IFVideoPicker/IF{*}.{h,m}', 'IFVideoPicker/NSData{*}.{h,m}', 'IFVideoPicker/NSMutableData+{*}.{h,m}', 'IFVideoPicker/IFBytesData.{h,m}'
